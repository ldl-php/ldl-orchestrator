...
class Builder
{
    ...
    public function getContainer(): ?ContainerInterface
    {
        if(false === $this->devMode){
            require_once $this->containerConfig->getContainerFilename();

            $options = $this->containerConfig->getDumpOptions();

            $class = sprintf('%s\\%s', $options['namespace'], $options['class']);
            return new $class();
        }
    ...
    {
        $this->envContent = $this->envBuilder->build();
    ...
    public static function fromJSONString(string $config) : Builder
    {
        ...
        $envFixedDate = $builderConfig->getEnvConfig();
        ...
        $containerFixedDate = $builderConfig->getContainerConfig();
        ...
        $devMode = OrchestratorConfig::MODE_PRODUCTION !== $orchestratorConfig->getMode();
        ...
        $instance->builderConfig = $builderConfig;
        return $instance;
    }
     ...
     *
     * @param BuilderConfig $mainConfig
     * @return BuilderConfig
     */
     ...
     */
    public function getOrchestratorConfig() : OrchestratorConfig
    {
        return $this->config;
    }
